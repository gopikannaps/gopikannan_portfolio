...
import srinath from "../assets/gopi.jpg";
    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        ...
        <p className="text-gray-500 py-4 max-w-md">
          ...
          Currently, I love to work on web technologies like I can apply my knowledge of HTML, CSS, Java script,React, PHP and
            MYSQL to develop innovative applications.
        </p>
        <div>
          <Link
            to="Portfolio"
